...
class PagedPlaylistSongWithPositionAdapter(private val onItemClick: ((position: Int) -> Unit)) :
    PagingDataAdapter<PlaylistSongItemUiModel, PagedPlaylistSongWithPositionAdapter.ViewHolder>(
